...
FROM (
    ...
    ON
        tbl.TABLE_NAME = col.TABLE_NAME
    WHERE
        tbl.TABLE_NAME in ('MODL_DEPT_LINK_M','JOBW_GRP_MNG_M','ITMCT_M','DF_STNG_DEPT_M','GNRL_CD_HDR_M','ITMCT_GRP_M','BU_M','DF_STNG_M','TRGT_SSN_M','SSN_M','PLN_SSN_DTL_M','PLN_SSN_M','PLN_DSPLY_CLS2_M','CLSZPTDM_M','SSN_CNV_M','WRHS_M','SCNTRY_BUSU_M','PRCZN_M','BUSU_M','BU_PRCZN_GRP_LK_M')
    ORDER BY
        col.TABLE_NAME
      , col.COLUMN_ID
)
